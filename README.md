...
Route `/term-test-2-computer-based/` là bản giao diện mở rộng của Term Test 2. Toàn bộ đề được dựng bằng HTML: Listening có ghi chú, bảng và lựa chọn ngay trong từng câu; Reading chia bài đọc và câu hỏi thành hai khung cuộn riêng. Listening bắt đầu bằng phòng chờ: đề bị ẩn trong lúc tải đủ audio, học viên phải bật đoạn nghe thử tối đa 30 giây và chỉnh âm lượng trước khi nút bắt đầu được mở. Mức âm lượng này được giữ cho toàn bộ bài thi. Audio thi thật quay về giây 0; đề và ô trả lời chỉ xuất hiện sau khi audio phát thành công. Nếu tải lỗi, bài vẫn khóa và có nút thử lại. Reading có đồng hồ 60 phút bắt đầu khi đề mở, cảnh báo đỏ ở 10 phút cuối và tự nộp, chấm, đồng bộ Portal rồi mở phân tích khi hết giờ. Mốc kết thúc được lưu trong phiên nên tải lại trang không làm đồng hồ quay về 60 phút. Trang vẫn có điều hướng câu và đánh dấu câu cần xem lại.
